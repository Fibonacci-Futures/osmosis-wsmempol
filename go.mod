...
replace (
	...
	// this fails cuz need the tag : github.com/cometbft/cometbft => github.com/Fibonacci-Futures/osmosid-cometbft  osmo-mempol
	github.com/cometbft/cometbft => ../osmosid-cometbft
